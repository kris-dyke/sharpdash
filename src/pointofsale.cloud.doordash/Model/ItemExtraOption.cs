...
namespace pointofsale.cloud.doordash.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ItemExtraOption :  IEquatable<ItemExtraOption>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemExtraOption" /> class.
        /// </summary>
        [JsonConstructor]
        protected ItemExtraOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemExtraOption" /> class.
        /// </summary>
        ...
        public ItemExtraOption(string name = default(string), string description = default(string), string merchantSuppliedId = default(string), bool? active = true, int? price = default(int?), int? basePrice = default(int?), bool? _default = default(bool?), int? sortId = default(int?), string taxRate = default(string), List<NestedItemExtra> extras = default(List<NestedItemExtra>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ItemExtraOption and cannot be null");
            }
            else
            {
                Name = name;
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for ItemExtraOption and cannot be null");
            }
            else
            {
                Price = price;
        ...
        public List<NestedItemExtra> Extras { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemExtraOption {\n");
        ...
        {
            return Equals(input as ItemExtraOption);
        }
