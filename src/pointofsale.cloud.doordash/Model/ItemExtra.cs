...
namespace pointofsale.cloud.doordash.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ItemExtra :  IEquatable<ItemExtra>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemExtra" /> class.
        /// </summary>
        [JsonConstructor]
        protected ItemExtra() { }
        /// <summary>
        ...
        public ItemExtra(string name = default(string), string description = default(string), string merchantSuppliedId = default(string), bool? active = true, int? sortId = default(int?), int? minNumOptions = default(int?), int? maxNumOptions = default(int?), int? numFreeOptions = default(int?), int? minOptionChoiceQuantity = default(int?), int? maxOptionChoiceQuantity = default(int?), int? minAggregateOptionsQuantity = default(int?), int? maxAggregateOptionsQuantity = default(int?), List<ItemExtraOption> options = default(List<ItemExtraOption>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ItemExtra and cannot be null");
            }
            else
            {
                Name = name;
        ...
        public List<ItemExtraOption> Options { get; set; }
        ...
        {
            return Equals(input as ItemExtra);
        }

        /// <summary>
        /// Returns true if ItemExtra instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemExtra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemExtra input)
        {
            if (input == null)
                return false;
