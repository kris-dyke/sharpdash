...
namespace pointofsale.cloud.doordash.Model
{
    ...
    /// </summary>
    [DataContract]
    public class OrderItemExtra :  IEquatable<OrderItemExtra>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderItemExtra" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="merchantSuppliedId">merchantSuppliedId.</param>
        /// <param name="options">options.</param>
        public OrderItemExtra(string name = default(string), string merchantSuppliedId = default(string), List<OrderItemExtraOption> options = default(List<OrderItemExtraOption>))
        {
            Name = name;
        ...
        public List<OrderItemExtraOption> Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderItemExtra {\n");
        ...
        {
            return Equals(input as OrderItemExtra);
        }

        /// <summary>
        /// Returns true if OrderItemExtra instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderItemExtra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderItemExtra input)
        {
            if (input == null)
                return false;
