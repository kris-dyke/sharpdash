...
namespace pointofsale.cloud.doordash.Model
{
    ...
    /// </summary>
    [DataContract]
    public class NestedItemExtra :  IEquatable<NestedItemExtra>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NestedItemExtra" /> class.
        /// </summary>
        [JsonConstructor]
        protected NestedItemExtra() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NestedItemExtra" /> class.
        /// </summary>
        ...
        public NestedItemExtra(string name = default(string), string description = default(string), string merchantSuppliedId = default(string), bool? active = true, int? sortId = default(int?), int? minNumOptions = default(int?), int? maxNumOptions = default(int?), int? numFreeOptions = default(int?), int? minOptionChoiceQuantity = default(int?), int? maxOptionChoiceQuantity = default(int?), int? minAggregateOptionsQuantity = default(int?), int? maxAggregateOptionsQuantity = default(int?), List<NestedItemExtraOption> options = default(List<NestedItemExtraOption>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NestedItemExtra and cannot be null");
            }
            else
            {
                Name = name;
        ...
        public List<NestedItemExtraOption> Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NestedItemExtra {\n");
        ...
        {
            return Equals(input as NestedItemExtra);
        }

        /// <summary>
        /// Returns true if NestedItemExtra instances are equal
        /// </summary>
        /// <param name="input">Instance of NestedItemExtra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NestedItemExtra input)
        {
            if (input == null)
                return false;
