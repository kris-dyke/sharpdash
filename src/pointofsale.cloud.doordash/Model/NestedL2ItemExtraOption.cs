...
{
    /// <summary>
    /// NestedL2ItemExtraOption
    /// </summary>
    [DataContract]
    public class NestedL2ItemExtraOption :  IEquatable<NestedL2ItemExtraOption>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NestedL2ItemExtraOption" /> class.
        /// </summary>
        [JsonConstructor]
        protected NestedL2ItemExtraOption() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NestedL2ItemExtraOption" /> class.
        /// </summary>
        ...
        public NestedL2ItemExtraOption(string name = default(string), string description = default(string), string merchantSuppliedId = default(string), bool? active = true, int? price = default(int?), int? basePrice = default(int?), bool? _default = default(bool?), int? sortId = default(int?), string taxRate = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NestedL2ItemExtraOption and cannot be null");
            }
            else
            {
                Name = name;
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for NestedL2ItemExtraOption and cannot be null");
            }
            else
            {
                Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NestedL2ItemExtraOption {\n");
        ...
        {
            return Equals(input as NestedL2ItemExtraOption);
        }

        /// <summary>
        /// Returns true if NestedL2ItemExtraOption instances are equal
        /// </summary>
        /// <param name="input">Instance of NestedL2ItemExtraOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NestedL2ItemExtraOption input)
        {
            if (input == null)
                return false;
